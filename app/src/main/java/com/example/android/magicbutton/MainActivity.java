...
{
    ImageView mg1,mg2,mg3,mg4,mg5,mg6,mg7;
...
//    ArrayAdapter<String> ab;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mg1 = (ImageView) findViewById(R.id.magicheater);
        mg2 = (ImageView) findViewById(R.id.magicmotor);
        mg3 = (ImageView) findViewById(R.id.magiciron);
        mg4 = (ImageView) findViewById(R.id.magiclight);
        mg5 = (ImageView) findViewById(R.id.magicfan);
        mg6 = (ImageView) findViewById(R.id.magicstreet);
        mg7 = (ImageView) findViewById(R.id.magicwash);
...
//        mg7.setMagicButtonClickListener(this);
        ...
        mg6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        mg7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
